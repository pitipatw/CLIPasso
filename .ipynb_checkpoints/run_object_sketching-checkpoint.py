...
print("Im in run_object_sketching.py")
...
for seed in seeds:
    ...
    if multiprocess:
        print("It's running in multiprocess mode, please wait for a while ...")
        P.apply_async(run, (seed, wandb_name))
    else:
        print("It's running in single process mode, please wait for a while ...")
        run(seed, wandb_name)
